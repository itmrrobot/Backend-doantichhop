...
const register = async(data) => {
    ...
    try {
        ...
        return res[1]?{err:1,mess:"Register success",access_token,refresh_token}:{err:0,mess:"Email is used"};
    } catch(e) {
        console.log(e);
    }
}
...
const login = async(data) => {
    console.log(data)
    try {
        const res = await User.findOne({where:{email:data.email},raw:true});
        console.log(res);
